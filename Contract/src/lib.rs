...
impl Contract {
    ...
    */
    ...
    pub fn get_link_to_data(&self) -> String {
        return String::from("https://bafybeig3ih2d7dom6xcksapn4ckbjomwz3gx6zxxkisltqhx54s3py6qym.ipfs.nftstorage.link/");
    }
    pub fn get_hash_of_data(&self) -> String {
        return String::from("c133bc5f0a2c77bebbc83e1bed1b86f483c9e88b");
    }
}